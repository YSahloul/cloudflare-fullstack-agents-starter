/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: b2e69c0723e4345ddf34a3cab0b6ea93)
// Runtime types generated with workerd@1.20251210.0 2025-10-14 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "PersonalAgent" | "WhatsAppBotAgent";
	}
	interface Env {
		CLOUDFLARE_ACCOUNT_ID: "my-cloudflare-account-id";
		CLOUDFLARE_AI_GATEWAY_ID: "whatsapp-agents-saas" | "whatsapp-agents-saas-preview";
		ENVIRONMENT: string;
		...
		PersonalAgent: DurableObjectNamespace<import("./worker/index").PersonalAgent>;
		WhatsAppBotAgent: DurableObjectNamespace<import("./worker/index").WhatsAppBotAgent>;
		DB: D1Database;
		WHATSAPP: Fetcher /* waha-cloudflare */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_AI_GATEWAY_ID" | "ENVIRONMENT" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "ANTHROPIC_API_KEY" | "OPENAI_API_KEY" | "WHATSAPP_API_KEY" | "ADMIN_API_KEY">> {}
}
